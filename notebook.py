...
trump_tweet = "Just signed a fantastic deal for America! Winning big, folks! #AmericaFirst #MAGA"
trudeau_tweet = "Positive talks today on building a stronger, inclusive Canada. Together, we can achieve progress for all. #Unity #CanadaStrong"
